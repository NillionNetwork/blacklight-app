...
export const STAKING_EVENTS = {
  ...
  UnstakeRequested: 'UnstakeRequested(address indexed staker, address indexed operator, uint256 amount, uint64 releaseTime)',
  Unstaked: 'Unstaked(address indexed operator, address indexed staker, uint256 amount)',
  UnstakedWithdrawn: 'UnstakedWithdrawn(address indexed staker, address indexed operator, uint256 amount)',
