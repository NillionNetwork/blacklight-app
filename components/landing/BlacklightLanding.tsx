...
export function BlacklightLanding() {
  ...
  const steps = [
    ...
    },
    {
      ...
      subtext: "Stake NIL to activate your node. The more you stake, the more verification work your node will be assigned.",
            ...
            <div className="relative grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start lg:items-center">
              ...
              <div className="space-y-8 order-1 lg:order-1 -mt-4 lg:-mt-2">
                ...
                <div className="space-y-2">
                  {/* Stage Indicator */}
                  <div className="text-sm md:text-base font-semibold tracking-wider uppercase" style={{ color: '#F2F2FF' }}>
                    Stage {activeStep} of 3
                  </div>

                  {/* Active Step Title and Description */}
                  <div className="space-y-0">
                    <h3 className="text-2xl md:text-3xl font-bold mb-0" style={{ color: '#FFFFFF' }}>
                      {steps[activeStep - 1].title}
                    </h3>
                    <p className="text-base md:text-lg leading-relaxed mt-0" style={{ color: '#F2F2FF' }}>
                ...
                <div className="flex items-center gap-4 pt-4">
                  <button
                    ...
                    style={{
                      border: '2px solid rgba(242, 242, 255, 0.2)',
                      backgroundColor: activeStep === 1 ? 'rgba(242, 242, 255, 0.05)' : 'rgba(242, 242, 255, 0.1)',
                      color: '#FFFFFF',
                  ...
                  <button
                    ...
                    style={{
                      border: '2px solid rgba(242, 242, 255, 0.2)',
                      backgroundColor: activeStep === 3 ? 'rgba(242, 242, 255, 0.05)' : 'rgba(242, 242, 255, 0.1)',
                      color: '#FFFFFF',
              ...
              <div className="p-6 lg:p-8 rounded-2xl" style={{ backgroundColor: 'rgba(65, 89, 246, 0.05)', border: '1px solid rgba(242, 242, 255, 0.1)' }}>
                ...
                <div className="pt-2">
                  <button
                    ...
                    onMouseEnter={(e) => {
                      e.currentTarget.style.background = 'linear-gradient(to right, #0000FF, #4159F6)'
                      e.currentTarget.style.boxShadow = '0 15px 35px -10px rgba(65, 89, 246, 0.5)'
                    }}
                    onMouseLeave={(e) => {
                      e.currentTarget.style.background = 'linear-gradient(to right, #4159F6, #0000FF)'
                      e.currentTarget.style.boxShadow = '0 15px 35px -10px rgba(65, 89, 246, 0.3)'
                    }}
                  >
                    Verify your app
          ...
          <div className="blacklight-nav-cards-container">
            ...
            <div className="blacklight-nav-cards-grid">
              ...
              <Link href="/workloads" className="blacklight-nav-card blacklight-nav-card-full">
                ...
                <p className="blacklight-nav-card-description">
                  For developers: Verify your apps and workloads running on TEE providers.
                </p>
              </Link>
            </div>
          </div>
